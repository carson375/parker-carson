      ...
      >
        ...
        {!hideNav && (
          <>
            ...
            {/* Mobile Menu Overlay */}
            {isMenuOpen && (
              <div className='fixed inset-0 z-[9998] md:hidden animate-in fade-in duration-300'>
                <div
                  className='absolute inset-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl'
                  onClick={() => setIsMenuOpen(false)}
                />
                <div className='relative flex flex-col items-center justify-center h-full gap-8 p-6'>
                  <Link
                    href='/'
                    className='text-2xl font-black text-primary hover:text-blue-500 transition-colors'
                  >
                    Home
                  </Link>
                  <Link
                  ...
                  <div className='flex flex-col items-center gap-4 pt-4 border-t border-gray-200 dark:border-gray-800 w-full max-w-[200px]'>
